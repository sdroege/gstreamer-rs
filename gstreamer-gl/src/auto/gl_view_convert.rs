...
use crate::{GLContext, GLStereoDownmix, ffi};
use glib::{
    prelude::*,
...
impl GLViewConvert {
    ...
    pub fn connect_input_flags_override_notify<F: Fn(&Self) + Send + Sync + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::input-flags-override".as_ptr(),
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
    ...
    pub fn connect_input_mode_override_notify<F: Fn(&Self) + Send + Sync + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::input-mode-override".as_ptr(),
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
    ...
    pub fn connect_output_flags_override_notify<F: Fn(&Self) + Send + Sync + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::output-flags-override".as_ptr(),
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
    ...
    pub fn connect_output_mode_override_notify<F: Fn(&Self) + Send + Sync + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::output-mode-override".as_ptr(),
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
