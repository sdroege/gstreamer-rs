...
int main() {
    ...
    PRINT_CONSTANT((gint) GST_WEBRTC_ICE_CANDIDATE_PROTOCOL_TYPE_TCP);
    PRINT_CONSTANT((gint) GST_WEBRTC_ICE_CANDIDATE_PROTOCOL_TYPE_UDP);
    PRINT_CONSTANT((gint) GST_WEBRTC_ICE_CANDIDATE_TYPE_HOST);
    PRINT_CONSTANT((gint) GST_WEBRTC_ICE_CANDIDATE_TYPE_PEER_REFLEXIVE);
    PRINT_CONSTANT((gint) GST_WEBRTC_ICE_CANDIDATE_TYPE_RELAYED);
    PRINT_CONSTANT((gint) GST_WEBRTC_ICE_CANDIDATE_TYPE_SERVER_REFLEXIVE);
    ...
    PRINT_CONSTANT((gint) GST_WEBRTC_KIND_APPLICATION);
