...
pub trait WebRTCICEExt: IsA<WebRTCICE> + 'static {
    ...
    fn close(&self, promise: Option<&gst::Promise>) {
        unsafe {
            ffi::gst_webrtc_ice_close(self.as_ref().to_glib_none().0, promise.to_glib_none().0);
        }
    }
