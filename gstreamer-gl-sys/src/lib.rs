...
impl ::std::fmt::Debug for GstGLShaderPrivate {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GstGLShaderPrivate @ {:?}", self as *const _))
         .finish()
    }
}
...
#[repr(C)]
pub struct GstGLUploadPrivate(c_void);

impl ::std::fmt::Debug for GstGLUploadPrivate {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GstGLUploadPrivate @ {:?}", self as *const _))
         .finish()
    }
}
...
#[repr(C)]
pub struct GstGLViewConvertPrivate(c_void);

impl ::std::fmt::Debug for GstGLViewConvertPrivate {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GstGLViewConvertPrivate @ {:?}", self as *const _))
         .finish()
    }
}
...
#[repr(C)]
pub struct GstGLWindowPrivate(c_void);

impl ::std::fmt::Debug for GstGLWindowPrivate {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GstGLWindowPrivate @ {:?}", self as *const _))
         .finish()
    }
}
