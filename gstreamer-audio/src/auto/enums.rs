...
#[non_exhaustive]
#[doc(alias = "GstAudioCdSrcMode")]
pub enum AudioCdSrcMode {
    #[doc(alias = "GST_AUDIO_CD_SRC_MODE_NORMAL")]
    Normal,
    #[doc(alias = "GST_AUDIO_CD_SRC_MODE_CONTINUOUS")]
    Continuous,
    #[doc(hidden)]
    __Unknown(i32),
}
...
#[doc(hidden)]
impl IntoGlib for AudioCdSrcMode {
    type GlibType = ffi::GstAudioCdSrcMode;

    #[inline]
    fn into_glib(self) -> ffi::GstAudioCdSrcMode {
        match self {
            Self::Normal => ffi::GST_AUDIO_CD_SRC_MODE_NORMAL,
            Self::Continuous => ffi::GST_AUDIO_CD_SRC_MODE_CONTINUOUS,
...
#[doc(hidden)]
impl FromGlib<ffi::GstAudioCdSrcMode> for AudioCdSrcMode {
    #[inline]
    unsafe fn from_glib(value: ffi::GstAudioCdSrcMode) -> Self {
        skip_assert_initialized!();

        match value {
            ffi::GST_AUDIO_CD_SRC_MODE_NORMAL => Self::Normal,
            ffi::GST_AUDIO_CD_SRC_MODE_CONTINUOUS => Self::Continuous,
            value => Self::__Unknown(value),
        }
    }
}

impl StaticType for AudioCdSrcMode {
    #[inline]
    #[doc(alias = "gst_audio_cd_src_mode_get_type")]
    fn static_type() -> glib::Type {
        unsafe { from_glib(ffi::gst_audio_cd_src_mode_get_type()) }
    }
}

impl glib::HasParamSpec for AudioCdSrcMode {
...
impl glib::value::ValueType for AudioCdSrcMode {
    type Type = Self;
}

unsafe impl<'a> glib::value::FromValue<'a> for AudioCdSrcMode {
...
impl ToValue for AudioCdSrcMode {
    #[inline]
...
impl From<AudioCdSrcMode> for glib::Value {
    #[inline]
    fn from(v: AudioCdSrcMode) -> Self {
        skip_assert_initialized!();
        ToValue::to_value(&v)
    }
}
