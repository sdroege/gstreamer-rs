...
const RUST_CONSTANTS: &[(&str, &str)] = &[
    ...
    ("(gint) GST_AUDIO_FORMAT_S20_32", "32"),
    ("(gint) GST_AUDIO_FORMAT_S20_32BE", "33"),
    ("(gint) GST_AUDIO_FORMAT_S20_32LE", "32"),
    ...
    ("(gint) GST_AUDIO_FORMAT_U20_32", "34"),
    ("(gint) GST_AUDIO_FORMAT_U20_32BE", "35"),
    ("(gint) GST_AUDIO_FORMAT_U20_32LE", "34"),
