...
int main() {
    ...
    PRINT_CONSTANT(GST_AUDIO_CONVERTER_OPT_DITHER_THRESHOLD);
    ...
    PRINT_CONSTANT((gint) GST_AUDIO_FORMAT_S20_32);
    PRINT_CONSTANT((gint) GST_AUDIO_FORMAT_S20_32BE);
    PRINT_CONSTANT((gint) GST_AUDIO_FORMAT_S20_32LE);
    ...
    PRINT_CONSTANT((gint) GST_AUDIO_FORMAT_U20_32);
    PRINT_CONSTANT((gint) GST_AUDIO_FORMAT_U20_32BE);
    PRINT_CONSTANT((gint) GST_AUDIO_FORMAT_U20_32LE);
