# gstreamer-rs [![crates.io](https://img.shields.io/crates/v/gstreamer-d3d12.svg)](https://crates.io/crates/gstreamer-d3d12) [![pipeline status](https://gitlab.freedesktop.org/gstreamer/gstreamer-rs/badges/main/pipeline.svg)](https://gitlab.freedesktop.org/gstreamer/gstreamer-rs/commits/main)

[GStreamer](https://gstreamer.freedesktop.org/) (Direct3D12 library) bindings for Rust.
Documentation can be found [here](https://gstreamer.pages.freedesktop.org/gstreamer-rs/stable/latest/docs/gstreamer_d3d12/).
