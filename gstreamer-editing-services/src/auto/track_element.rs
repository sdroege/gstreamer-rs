...
pub trait TrackElementExt: IsA<TrackElement> + 'static {
    ...
    //fn all_control_bindings(&self) -> /*Unknown conversion*//*Unimplemented*/HashTable TypeId { ns_id: 0, id: 28 }/TypeId { ns_id: 6, id: 93 } {
    ...
    //fn all_control_bindings_full(&self) -> /*Unknown conversion*//*Unimplemented*/HashTable TypeId { ns_id: 0, id: 28 }/TypeId { ns_id: 6, id: 93 } {
    ...
    fn connect_control_binding_added<F: Fn(&Self, &gst::ControlBinding) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                ...
                c"control-binding-added".as_ptr(),
    ...
    fn connect_control_binding_removed<F: Fn(&Self, &gst::ControlBinding) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"control-binding-removed".as_ptr(),
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
    ...
    fn connect_auto_clamp_control_sources_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::auto-clamp-control-sources".as_ptr(),
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
    ...
    fn connect_has_internal_source_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::has-internal-source".as_ptr(),
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
