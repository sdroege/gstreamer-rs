...
impl Asset {
    ...
    #[doc(alias = "needs_reload")]
    pub fn needs_reload_with_type(extractable_type: glib::types::Type, id: Option<&str>) -> bool {
    ...
    #[doc(alias = "request_async")]
    pub fn request_async_with_type<P: FnOnce(Result<Asset, glib::Error>) + 'static>(
        extractable_type: glib::types::Type,
        id: Option<&str>,
        ...
        unsafe extern "C" fn request_async_with_type_trampoline<
        ...
        let callback = request_async_with_type_trampoline::<P>;
        unsafe {
    ...
    pub fn request_async_with_type_future(
        extractable_type: glib::types::Type,
        id: Option<&str>,
