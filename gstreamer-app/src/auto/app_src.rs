...
impl AppSrc {
    ...
    //pub fn set_callbacks(&self, callbacks: /*Ignored*/Option<&mut AppSrcCallbacks>, user_data: /*Unimplemented*/Option<Basic: Pointer>) {
    ...
    pub fn connect_handle_segment_change_notify<F: Fn(&Self) + Send + Sync + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::handle-segment-change".as_ptr(),
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
