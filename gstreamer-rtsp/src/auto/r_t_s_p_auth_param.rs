...
glib_wrapper! {
    ...
    match fn {
        copy => |ptr| gobject_ffi::g_boxed_copy(ffi::gst_rtsp_auth_param_get_type(), ptr as *mut _) as *mut ffi::GstRTSPAuthParam,
        free => |ptr| gobject_ffi::g_boxed_free(ffi::gst_rtsp_auth_param_get_type(), ptr as *mut _),
