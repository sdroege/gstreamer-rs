...
glib_wrapper! {
    ...
    match fn {
        copy => |ptr| gobject_ffi::g_boxed_copy(ffi::gst_rtsp_url_get_type(), ptr as *mut _) as *mut ffi::GstRTSPUrl,
        free => |ptr| gobject_ffi::g_boxed_free(ffi::gst_rtsp_url_get_type(), ptr as *mut _),
