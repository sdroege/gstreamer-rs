...
impl TocRef {
    ...
    pub fn find_entry(&self, uid: &str) -> Option<TocEntry> {
        unsafe {
            let toc_entry = ffi::gst_toc_find_entry(
                self.as_ptr(),
                uid.to_glib_none().0,
            );
    ...
    pub fn get_entries(&self) -> Vec<TocEntry> {
        unsafe {
            FromGlibPtrContainer::from_glib_none(
                ffi::gst_toc_get_entries(self.as_ptr())
            )
        }
    }
    ...
    pub fn dump(&self) {
        unsafe { ffi::gst_toc_dump(self.as_mut_ptr()); }
    }
}
...
impl TocEntryRef {
    ...
    pub fn append_sub_entry(&mut self, subentry: TocEntry) {
        unsafe {
            ffi::gst_toc_entry_append_sub_entry(
                self.as_mut_ptr(),
                subentry.into_ptr(),
            );
        }
    ...
    pub fn get_sub_entries(&self) -> Vec<TocEntry> {
        unsafe {
            FromGlibPtrContainer::from_glib_none(
                ffi::gst_toc_entry_get_sub_entries(self.as_ptr())
            )
        }
    }
    ...
    pub fn set_start_stop_times(&mut self, start: i64, stop: i64) {
        unsafe {
            ffi::gst_toc_entry_set_start_stop_times(
                self.as_mut_ptr(),
                start,
                stop
            );
    ...
    pub fn is_alternative(&self) -> bool {
        unsafe {
            from_glib(ffi::gst_toc_entry_is_alternative(self.as_ptr()))
        }
    }

    pub fn is_sequence(&self) -> bool {
        unsafe {
            from_glib(ffi::gst_toc_entry_is_sequence(self.as_ptr()))
        }
    }
