...
int main() {
    ...
    PRINT_CONSTANT((guint) GST_MAP_REF_MEMORY);
    ...
    PRINT_CONSTANT((guint) GST_MESSAGE_DEVICE_MONITOR_STARTED);
    ...
    PRINT_CONSTANT(GST_META_TAG_MEMORY_REFERENCE_STR);
    ...
    PRINT_CONSTANT((guint) GST_OBJECT_FLAG_CONSTRUCTED);
    ...
    PRINT_CONSTANT((guint) GST_PLUGIN_FLAG_STATIC_FEATURES);
    ...
    PRINT_CONSTANT((gint) GST_QUERY_SELECTABLE);
    ...
    PRINT_CONSTANT((guint) GST_STREAM_TYPE_METADATA);
    ...
    PRINT_CONSTANT(GST_TAG_ALBUM_GAIN_R128);
    ...
    PRINT_CONSTANT(GST_TAG_TRACK_GAIN_R128);
    ...
    PRINT_CONSTANT(GST_TASK_POOL_CONTEXT_TYPE);
    ...
    PRINT_CONSTANT((gint) GST_TRACER_FIELD_TYPE_BOOLEAN);
    PRINT_CONSTANT((gint) GST_TRACER_FIELD_TYPE_CLOCK_TIME);
    PRINT_CONSTANT((gint) GST_TRACER_FIELD_TYPE_DOUBLE);
    PRINT_CONSTANT((gint) GST_TRACER_FIELD_TYPE_INT);
    PRINT_CONSTANT((gint) GST_TRACER_FIELD_TYPE_INT64);
    PRINT_CONSTANT((gint) GST_TRACER_FIELD_TYPE_OBJECT);
    PRINT_CONSTANT((gint) GST_TRACER_FIELD_TYPE_STRING);
    PRINT_CONSTANT((gint) GST_TRACER_FIELD_TYPE_STRUCTURE);
    PRINT_CONSTANT((gint) GST_TRACER_FIELD_TYPE_UINT);
    PRINT_CONSTANT((gint) GST_TRACER_FIELD_TYPE_UINT64);
    ...
    PRINT_CONSTANT(GST_TRACE_SPAN_ID_NONE);
