...
impl Discoverer {
    //pub fn new(timeout: /*Ignored*/gst::ClockTime) -> Result<Discoverer, Error> {
    //    unsafe { TODO: call ffi::gst_discoverer_new() }
    //}
}
...
pub trait DiscovererExt {
    ...
    //fn connect_source_setup<Unsupported or ignored types>(&self, f: F) -> SignalHandlerId;
