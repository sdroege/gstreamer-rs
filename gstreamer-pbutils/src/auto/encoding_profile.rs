...
glib_wrapper! {
    pub struct EncodingProfile(Object<ffi::GstEncodingProfile>);
...
impl EncodingProfile {
    ...
    //pub fn from_discoverer(info: /*Ignored*/&DiscovererInfo) -> Option<EncodingProfile> {
    //    unsafe { TODO: call ffi::gst_encoding_profile_from_discoverer() }
    //}
}
