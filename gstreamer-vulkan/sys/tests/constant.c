...
int main() {
    PRINT_CONSTANT(GST_BUFFER_POOL_OPTION_VULKAN_IMAGE_MULTIPLANAR_YUV);
    PRINT_CONSTANT(GST_CAPS_FEATURE_MEMORY_VULKAN_BUFFER);
    PRINT_CONSTANT(GST_CAPS_FEATURE_MEMORY_VULKAN_IMAGE);
    PRINT_CONSTANT(GST_VULKAN_API_VERSION_FORMAT);
    ...
    PRINT_CONSTANT((gint) GST_VULKAN_HANDLE_TYPE_SEMAPHORE);
    ...
    PRINT_CONSTANT(GST_VULKAN_REQUESTED_DEVICE_EXTENSIONS_CONTEXT_TYPE_STR);
    PRINT_CONSTANT(GST_VULKAN_REQUESTED_INSTANCE_EXTENSIONS_CONTEXT_TYPE_STR);
    PRINT_CONSTANT(GST_VULKAN_SWAPPER_VIDEO_FORMATS);
    PRINT_CONSTANT(GST_VULKAN_UUID_FORMAT);
